...
function Paper() {
    ...
    >([]);
    const [selectedFeature, setSelectedFeature] = useState<"summary" | "explanation" | "chat">("summary");
    ...
    const handleAskAI = async () => {
        ...
        try {
            ...
            toast.error(err.response?.data?.error || "Error asking AI");
        } finally {
    ...
    const GetSummary = useCallback(async () => {
        ...
        try {
            ...
            const err = error as { response?: { data?: { error?: string } } };
            toast.error(err.response?.data?.error || "Error fetching AI summary");
        } finally {
    ...
    const handleExplainSelection = async () => {
        ...
        try {
            ...
            const err = error as { response?: { data?: { error?: string } } };
            toast.error(err.response?.data?.error || "Error fetching explanation");
        } finally {
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {/* --- Feature buttons --- */}
                    <div className="flex justify-around bg-gray-50 border-b border-gray-200 py-3">
                        <button
                        ...
                        <button
                            onClick={() => setSelectedFeature("explanation")}
                            className={`font-medium px-3 py-2 rounded-lg transition-colors ${
                    ...
                    <div className="p-6 space-y-6 max-h-[calc(100vh-18rem)] overflow-y-auto">
    ...
    className={`w-full font-bold py-4 px-6 rounded-xl shadow-lg transition-all duration-200 flex items-center justify-center gap-2
        ${loadingExplanation
        ...
        <>
            ...
            Explain Selected Text
                                ...
                                <p className="text-xs text-center text-gray-500">
                                    Select text from the PDF and click the button above
                                </p>
        ...
        <h4 className="font-semibold text-amber-800 mb-2 flex items-center gap-2">
            ...
            >
                <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M3 5h12M9 3v2m0 4v12m0 0l3-3m-3 3l-3-3"
                />
            </svg>
            Selected Text
        </h4>
        <blockquote className="italic text-sm text-gray-700 border-l-4 border-amber-400 pl-3">
            {selectedText}
        </blockquote>
    </div>
)}
...
{aiExplanation && (
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-200 animate-fadeIn mt-4">
                                ...
                                <h3 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
                                    ...
                                    >
                                        <path
                                            ...
                                            strokeLinejoin="round"
                                            strokeWidth={2}
                                            d="M8 10h8m-8 4h5m9 0a9 9 0 11-18 0 9 9 0 0118 0z"
                                        />
                                    </svg>
                                    Ask the AI
                                </h3>
                                ...
                                <div className="space-y-3 max-h-64 overflow-y-auto mb-4">
                                    {chatHistory.map((chat, index) => (
                                        <div key={index}>
                                            ...
                                            <p className="text-gray-800 mb-2">{chat.question}</p>
    ...
    className={`font-bold px-4 py-2 rounded-lg text-sm transition-all duration-200
        ${loadingChat
